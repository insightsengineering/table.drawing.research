...
This page displays the current gtsummary table to Word output
...
gt::gtsave(gt_table, filename = "outputs/tab_1.docx")

  
```

Embedding a word document is difficult - we convert the word document into a pdf for display purposes.
...
# doc <- read_docx("outputs/tab_1.docx")
# 
# # Save the content into a temporary Rmd file
...
# render(rmd_file, output_file = "outputs/tab_1_word.pdf")

```


```{=html}
<iframe src="outputs/tab_1_word.pdf" width="100%" height="800"></iframe>
