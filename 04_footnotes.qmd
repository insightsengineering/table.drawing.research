...
```
###### Preview the Output
![](outputs/docx/footnotes_gt_word.docx){width=80% height=1000}
-   no issues
...
```
###### Preview the Output
![](outputs/docx/footnotes_qmd_word.docx){width=80% height=1000}
- no issues
...
```
###### Preview the Output
![](outputs/docx/footnotes_rmd_word.docx){width=80% height=1000}
-   no issues
