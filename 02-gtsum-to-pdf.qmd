...
This page displays the current gtsummary table to PDF output
...
# Save to PDF
# gt::gtsave(gt_table, filename = "outputs/tab_1.pdf")

  
```

```{=html}
<iframe src="outputs/tab_1.pdf" width="100%" height="800"></iframe>
