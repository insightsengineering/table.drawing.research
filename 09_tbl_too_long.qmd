...
```
###### Preview the Output
![](outputs/docx/too_long_gt_word.docx){width=80% height=1000}
...
```
###### Preview the Output
![](outputs/docx/too_long_qmd_word.docx){width=80% height=1000}
-   printed on multiple pages (continued)
-   header repeated on each page
-   footer only on the last page
...
```
###### Preview the Output
![](outputs/docx/too_long_rmd_word.docx){width=80% height=1000}
-   printed on multiple pages (continued)
-   header repeated on each page
-   footer only on the last page
