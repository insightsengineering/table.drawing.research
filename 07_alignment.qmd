...
```
###### Preview the Output
![](outputs/docx/alignment_gt_word.docx){width=80% height=1000}
-   no issues
...
```
###### Preview the Output
![](outputs/docx/alignment_qmd_word.docx){width=80% height=1000}
-   no issues
...
```
###### Preview the Output
![](outputs/docx/alignment_rmd_word.docx){width=80% height=1000}
-   no issues
