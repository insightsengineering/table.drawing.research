...
```
###### Preview the Output
![](outputs/docx/bold_gt_word.docx){width=80% height=1000}
-   no issues
...
```
###### Preview the Output
![](outputs/docx/bold_qmd_word.docx){width=80% height=1000}
-   no issues
...
```
###### Preview the Output
![](outputs/docx/bold_rmd_word.docx){width=80% height=1000}
-   no issues
