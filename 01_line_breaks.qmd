...
```
###### Preview the Output
![](outputs/docx/linebreaks_gt_word.docx){width=80% height=1000}
...
```
###### Preview the Output
![](outputs/docx/linebreaks_qmd_word.docx){width=80% height=1000}
-   title linebreak not working
-   cell linebreak not working
-   manual linebreaks work
...
```
###### Preview the Output
![](outputs/docx/linebreaks_rmd_word.docx){width=80% height=1000}
-   title linebreak not working
-   cell linebreak not working
-   manual linebreaks work
