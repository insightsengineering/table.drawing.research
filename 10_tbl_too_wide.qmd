...
```
###### Preview the Output
![](outputs/docx/too_wide_gt_word.docx){width=80% height=1000}
...
```
###### Preview the Output
![](outputs/docx/too_wide_qmd_word.docx){width=80% height=1000}
- table condensed (squished) to fit on the page (text wrapping within cells)
...
```
###### Preview the Output
![](outputs/docx/too_wide_rmd_word.docx){width=80% height=1000}
-   table condensed (squished) to fit on the page (text wrapping within cells)
