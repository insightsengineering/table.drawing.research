...
## docx output using as_flextable()

This work has been deprioritized as table customizations are done using {gt} functions which is not compatible with the `as_flextable` function in {gtsummary}. {flextable} functions will need to be used to add table customzation AND export.


## Modifying the gt table before export
