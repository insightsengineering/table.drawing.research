...
```{r}
library(gtsummary)
tbl <- gtsummary::tbl_summary(gtsummary::trial, by = trt, include = c(age, grade), missing = "always", label = list(age = "Age  \\linebreak in a cell")) |> add_overall() # xxx this line break character needed to be changed to run wihtout error
tbl$table_body |> 
