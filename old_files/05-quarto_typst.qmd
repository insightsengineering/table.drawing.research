...
tbl$table_body |> 
  ...
  # Indentation xxx This doesn't work
  gt::text_transform(
  ...
  # Bold cells in table xxx this doesn't work
  gt::tab_style(
  ...
  gt::cols_label(
    ...
    stat_1 = gt::md("**Drug A**  \nManual Line Break"), # xxx line breaks don't work
    stat_2 = gt::md("**Drug B**  \nManual Line Break")
  ) |> 
  # Column alignment
  gt::cols_align(columns = c(stat_1, stat_2), align = "right") |> # xxx this alignment doesn't work
  # Spanning headers # cells aren't being merged for spanning headers
  ...
  gt::tab_footnote("Footnote in Subtitle", locations = gt::cells_title("subtitle")) |> # xxx no subtitle so no footnote 
  gt::tab_footnote("Footnote in Title", locations = gt::cells_title("title"))
# xxx This is as far as it goes, when adding source notes, the table fails to render
