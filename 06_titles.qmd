...
```
###### Preview the Output
![](outputs/docx/titles_gt_word.docx){width=80% height=1000}
...
```
###### Preview the Output
![](outputs/docx/titles_qmd_word.docx){width=80% height=1000}
-   Titles present but right justified
-   no caption
...
```
###### Preview the Output
![](outputs/docx/titles_rmd_word.docx){width=80% height=1000}
-   Titles present but right justified
-   no caption
