...
```
###### Preview the Output
![](outputs/docx/spanning_header_gt_word.docx){width=80% height=1000}
-   no issues
...
```
###### Preview the Output
![](outputs/docx/spanning_header_qmd_word.docx){width=80% height=1000}
-   no issues
...
```
###### Preview the Output
![](outputs/docx/spanning_header_rmd_word.docx){width=80% height=1000}
-   no issues
